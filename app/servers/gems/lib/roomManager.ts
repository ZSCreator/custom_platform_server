 ...
 * 幸运777房间管理
 */
export class gemsRoomManager extends RoomManager<Room>{
     ...
     */
    async init() {
        const sceneList = getConfiguration('scenes/gems').datas;
...
export default new gemsRoomManager(GameNidEnum.gems, InteriorGameType.Slots, 'gems');