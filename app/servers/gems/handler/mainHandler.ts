...
import roomManager, { gemsRoomManager } from "../lib/roomManager";
...
export class MainHandler {
    ...
    /**
     * 申请奖池信息
     * @route: gems.mainHandler.jackpotFund
     */
    ...
    /**
     * 初始化，进入游戏获取玩家的金币
     * @route: gems.mainHandler.loadGold
     */
