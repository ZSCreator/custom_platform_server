 ...
 * 冰球突破房房间管理
 */
export class IceBallRoomManager extends RoomManager<Room>{
     ...
     */
    async init() {
        const sceneList = getConfiguration('scenes/iceBall').datas;
...
export default new IceBallRoomManager(GameNidEnum.IceBall, InteriorGameType.Slots, '冰球突破');