 ...
 * 幸运777房间管理
 */
export class TriplePandaRoomManager extends RoomManager<Room>{
     ...
     */
    async init() {
        const sceneList = getConfiguration('scenes/TriplePanda').datas;
...
export default new TriplePandaRoomManager(GameNidEnum.TriplePanda, InteriorGameType.Slots, 'TriplePanda');