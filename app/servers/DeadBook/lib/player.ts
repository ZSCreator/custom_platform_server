...
import {BoTimes, defaultLineNum, PlayerGameState} from "./constant";
...
export default class Player extends SlotMachinePlayer {
    ...
    bet(baseBet: number) {
        ...
        this.lineNumber = defaultLineNum;
        this.totalBet = baseBet * defaultLineNum;
    ...
    isLackGold(baseBet: number) {
        return this.gold < baseBet * defaultLineNum;
    }
