 ...
 * 幸运777房间管理
 */
export class BingoMoneyRoomManager extends RoomManager<Room>{
     ...
     */
    async init() {
        const sceneList = getConfiguration('scenes/BingoMoney').datas;
...
export default new BingoMoneyRoomManager(GameNidEnum.BingoMoney, InteriorGameType.Slots, 'BingoMoney');