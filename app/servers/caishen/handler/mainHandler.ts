...
export class MainHandler {
    ...
    /**
     * 加载获取参数
     * @route caishen.mainHandler.load
     */
     ...
     * 开始游戏
     * @param bet 基础押注
     * @route caishen.mainHandler.start
     */
    ...
    /**
     * 申请奖池信息
     * @route: caishen.mainHandler.jackpotFund
     */
    ...
    /**
     * 初始化，进入游戏获取玩家的金币
     * @route: caishen.mainHandler.loadGold
     */
