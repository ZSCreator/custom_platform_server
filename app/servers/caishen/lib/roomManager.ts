 ...
 * 幸运777房间管理
 */
export class caishenRoomManager extends RoomManager<Room>{
     ...
     */
    async init() {
        const sceneList = getConfiguration('scenes/caishen').datas;
...
export default new caishenRoomManager(GameNidEnum.caishen, InteriorGameType.Slots, 'caishen');