 ...
 * 猴王传奇房房间管理
 */
export class XYJRoomManager extends RoomManager<Room>{
     ...
     */
    async init() {
        const sceneList = getConfiguration('scenes/xiyouji').datas;
...
export default new XYJRoomManager(GameNidEnum.xiyouji, InteriorGameType.Slots, '猴王传奇');