 ...
 * 寻宝奇航房间管理
 */
export class PirateRoomManager extends RoomManager<Room> {
     ...
     */
    async init() {
        const sceneList = getConfiguration('scenes/pirate').datas;
...
export default new PirateRoomManager(GameNidEnum.pirate, InteriorGameType.Slots, '寻宝奇航');