...
/**
 * @property lastCards 剩余得其他三张牌
 * @property bankCard 庄家手牌
 * @property idlerCard 闲家手牌
 * @property totalWin slots赢取得金币
 * @property finallyWin 翻倍过后赢取得金币
 */

interface goldDoubleResult {
    lastCards: number [],
    bankCard: number,
    idlerCard: number,
    totalWin: number,
 ...
 * @property playerWin 玩家在slots 得说话赢取多少金币
...
export default class Player extends SlotMachinePlayer {
    ...
    status: 1 | 2 = 1;
    roundId: string;
    goldDoubleResult: goldDoubleResult;
