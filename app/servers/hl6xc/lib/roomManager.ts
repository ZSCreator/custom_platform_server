 ...
 * 幸运777房间管理
 */
export class hl6xcRoomManager extends RoomManager<Room>{
     ...
     */
    async init() {
        const sceneList = getConfiguration('scenes/hl6xc').datas;
...
export default new hl6xcRoomManager(GameNidEnum.hl6xc, InteriorGameType.Slots, 'hl6xc');