...
import {ColorPlateRoomManager} from "./roomManager";
import RouteMessage from "./classes/routeMessage";
import { remove } from '../../../utils';
import { betAreaOdds, BetAreasName } from "./config/betAreas";
...
export class Room extends MultiPlayerRoom<Player>{
    private readonly MAX_HISTORY_LENGTH = 75;
    ...
    public roomManager: ColorPlateRoomManager;
    ChipList: number[];

    constructor(props, roomManager: ColorPlateRoomManager) {
        super(props);
     ...
     * @param result
     */
    addOneLotteryResult(result: string[]) {
...
function initBetAreas(): { [key in BetAreasName]: BetArea } {
    return {
        [BetAreasName.SINGLE]: new BetArea(betAreaOdds[BetAreasName.SINGLE]),
        [BetAreasName.DOUBLE]: new BetArea(betAreaOdds[BetAreasName.DOUBLE]),
        [BetAreasName.FOUR_WHITE]: new BetArea(betAreaOdds[BetAreasName.FOUR_WHITE]),
        [BetAreasName.FOUR_RED]: new BetArea(betAreaOdds[BetAreasName.FOUR_RED]),
        [BetAreasName.THREE_RED]: new BetArea(betAreaOdds[BetAreasName.THREE_RED]),
        [BetAreasName.THREE_WHITE]: new BetArea(betAreaOdds[BetAreasName.THREE_WHITE]),
    }
}