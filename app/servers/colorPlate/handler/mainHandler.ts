...
export class mainHandler {
     ...
     * @route colorPlate.mainHandler.load
     **/
     ...
     * 下注
     * @return {Object}
     * @route colorPlate.mainHandler.bet
     **/
     ...
     * 续押
     * @return {Object}
     * @route colorPlate.mainHandler.renew
     **/
     ...
     * 申请上庄
     * @return {Object} 上庄结果
     * @route colorPlate.mainHandler.applyToBeBanker
     **/
    async applyToBeBanker({ room, player }: { room: Room, player: Player }, session: FrontendSession): Promise<object> {
        return { code: 200 };
    }
     ...
     * 申请下庄
     * @return {Object} 下庄结果
     * @route colorPlate.mainHandler.applyToBePlayer
     **/
    async applyToBePlayer({ room, player }: { room: Room, player: Player }, session: FrontendSession): Promise<object> {
        return { code: 200 };
    }
     ...
     * 获取玩家列表
     * @return {Object} 玩家列表
     * @route colorPlate.mainHandler.getPlayers
     **/
